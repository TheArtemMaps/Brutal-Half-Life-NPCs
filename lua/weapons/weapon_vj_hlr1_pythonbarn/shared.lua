...
SWEP.Category					= "VJ Base"
	-- NPC Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.NPC_ReloadSound = {"weapons2/357_reload1.wav"} -- Sounds it plays when the base detects the SNPC playing a reload animation
...
SWEP.Primary.Sound = {"weapons2/357_shot1.wav","weapons2/357_shot2.wav"}
SWEP.Primary.DistantSound = {"weapons2/357_shot_distant_final.wav"}
SWEP.Primary.TracerType = "VJ_HLR_Tracer"
SWEP.PrimaryEffects_ShellType 	= "VJ_Weapon_PistolShell1"
-- Sound
SWEP.HasDryFireSound = true -- Should it play a sound when it's out of ammo?
SWEP.DryFireSound = {"weapons2/357_cock1.wav"} -- The sound that it plays when the weapon is out of ammo
if CLIENT then
killicon.Add("weapon_vj_hlr1_pythonbarn", "temka/icons/357", Color(255, 255, 255))
end
-- Custom
SWEP.HLR_ValidModels = {
	"models/hl1/pythonbarney.mdl",
	"models/hl1/pythonotis.mdl"
}
---------------------------------------------------------------------------------------------------------------------------------------------
