...
SWEP.NPC_ReloadSound			= {"weapons2/shotgunreload.wav"} -- Sounds it plays when the base detects the SNPC playing a reload animation
SWEP.NPC_ExtraFireSound			= {"weapons2/scock1.wav"} -- Plays an extra sound after it fires (Example: Bolt action sound)
...
SWEP.Primary.Sound				= {"weapons2/sbarrel12.wav","weapons2/sbarrel12.wav","weapons2/sbarrel12.wav"}
SWEP.Primary.DistantSound		= {"weapons2/sbarrel1_w.wav"}
SWEP.PrimaryEffects_ShellType 	= "VJ_Weapon_ShotgunShell1"
SWEP.Primary.TracerType = "VJ_HLR_Tracer"
if CLIENT then
killicon.Add("weapon_vj_hlr1_spas12barn", "temka/icons/shotgun", Color(255, 255, 255))
end
-- Custom
SWEP.HLR_ValidModels = {"models/hl1/shotgunbarney.mdl","models/hl1/shotgunotis.mdl","models/hl1/shotgunbarney2.mdl","models/hl1/hgrunt.mdl"}
---------------------------------------------------------------------------------------------------------------------------------------------
