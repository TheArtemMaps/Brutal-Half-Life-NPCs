...
SWEP.PrintName					= "Dual Glock 17"
SWEP.Author 					= "TheArtemMaps"
...
SWEP.WorldModel					= "models/hl1/w_9mmhandgun.mdl"
...
SWEP.Primary.ClipSize			= 34 -- Max amount of bullets per clip
...
-- Custom
SWEP.HLR_ValidModels = {"models/hl1/akimbobarney.mdl"}
---------------------------------------------------------------------------------------------------------------------------------------------
...
function SWEP:CustomOnFireAnimationEvent(pos,ang,event,options)
	if event == 1100 then return true end
end