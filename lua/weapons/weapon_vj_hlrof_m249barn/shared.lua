...
SWEP.NPC_ReloadSound			= {"weapons2/saw_reload2.wav"} -- Sounds it plays when the base detects the SNPC playing a reload animation
...
SWEP.Primary.Sound				= {"weapons2/saw_fire.wav","weapons2/saw_fire.wav","weapons2/saw_fire.wav"}
SWEP.Primary.DistantSound		= {"weapons2/saw_fire_w.wav"}
SWEP.Primary.TracerType = "VJ_HLR_Tracer"
if CLIENT then
killicon.Add("weapon_vj_hlrof_m249barn", "temka/icons/m249_killicon", Color(255, 255, 255))
end
-- Custom
SWEP.HLR_ValidModels = {"models/hl1/sawbarney.mdl","models/hl1/sawotis.mdl","models/hl1/sawhgrunt.mdl"}
---------------------------------------------------------------------------------------------------------------------------------------------
