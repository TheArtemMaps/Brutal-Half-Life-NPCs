...
SWEP.Primary.Sound = {"weapons2/hks1.wav","weapons2/hks1.wav","weapons2/hks1.wav"}
SWEP.Primary.DistantSound = {"weapons2/hks1_distant.wav"}
SWEP.Primary.TracerType = "VJ_HLR_Tracer"
if CLIENT then
killicon.Add("weapon_vj_hlr1_mp5barn", "temka/icons/mp5", Color(255, 255, 255))
end
-- Custom
SWEP.HLR_ValidModels = {
	"models/hl1/barney.mdl",
	"models/hl1/mp5otis.mdl",
	"models/hl1/hgrunt.mdl"
}
---------------------------------------------------------------------------------------------------------------------------------------------
