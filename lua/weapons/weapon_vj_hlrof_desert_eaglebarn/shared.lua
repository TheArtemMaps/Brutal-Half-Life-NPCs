...
SWEP.Primary.Sound				= {"weapons2/desert_eagle_fire.wav", "weapons2/desert_eagle_fire2.wav"}
SWEP.Primary.DistantSound		= {"vj_hlr/hl1_weapon/deagle/desert_eagle_fire_distant_final.wav"}
SWEP.PrimaryEffects_ShellType 	= "VJ_Weapon_PistolShell1"
SWEP.Primary.TracerType = "VJ_HLR_Tracer"
if CLIENT then
killicon.Add("weapon_vj_hlrof_desert_eaglebarn", "temka/icons/eagle_killicon", Color(255, 255, 255))
end
-- Custom
SWEP.HLR_ValidModels = {"models/hl1/deaglebarney.mdl"}
---------------------------------------------------------------------------------------------------------------------------------------------
