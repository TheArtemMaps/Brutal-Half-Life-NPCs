...
-----------------------------------------------*/
ENT.Model = {"models/hl1/sniperbarney.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 90
...
function ENT:CustomOnInitialize()
    ...
    if self:GetModel() == "models/hl1/barney.mdl" then
