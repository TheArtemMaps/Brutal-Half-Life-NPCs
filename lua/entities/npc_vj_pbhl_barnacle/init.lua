...
-----------------------------------------------*/
ENT.Model = {"models/hl1/barnacle.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
...
function ENT:CustomOnAcceptInput(key, activator, caller, data)
	...
	if key == "death_gibs" then
		...
		self:CreateGibEntity("obj_vj_gib","models/gib/hgibs" .. math.random(2, 3) .. ".mdl",{BloodDecal="VJ_HLR_Blood_Red",Pos=self:LocalToWorld(Vector(-1,0,-30))})
...
function ENT:SetUpGibesOnDeath(dmginfo, hitgroup)
	...
	self:CreateGibEntity("obj_vj_gib","models/vj_hlr/gibs/flesh1.mdl",{BloodDecal="VJ_HLR_Blood_Red",Pos=self:LocalToWorld(Vector(0,1,-20)),CollideSound={ "gore/flesh" .. math.random(1, 3) .. ".wav"}})
	self:CreateGibEntity("obj_vj_gib","models/vj_hlr/gibs/flesh2.mdl",{BloodDecal="VJ_HLR_Blood_Red",Pos=self:LocalToWorld(Vector(0,2,-20)),CollideSound={ "gore/flesh" .. math.random(1, 3) .. ".wav"}})
	self:CreateGibEntity("obj_vj_gib","models/vj_hlr/gibs/flesh3.mdl",{BloodDecal="VJ_HLR_Blood_Red",Pos=self:LocalToWorld(Vector(0,3,-20)),CollideSound={ "gore/flesh" .. math.random(1, 3) .. ".wav"}})
	self:CreateGibEntity("obj_vj_gib","models/vj_hlr/gibs/flesh4.mdl",{BloodDecal="VJ_HLR_Blood_Red",Pos=self:LocalToWorld(Vector(0,4,-20)),CollideSound={ "gore/flesh" .. math.random(1, 3) .. ".wav"}})
	self:CreateGibEntity("obj_vj_gib","models/vj_hlr/gibs/flesh1.mdl",{BloodDecal="VJ_HLR_Blood_Red",Pos=self:LocalToWorld(Vector(0,5,-20)),CollideSound={ "gore/flesh" .. math.random(1, 3) .. ".wav"}})
	self:CreateGibEntity("obj_vj_gib","models/vj_hlr/gibs/flesh2.mdl",{BloodDecal="VJ_HLR_Blood_Red",Pos=self:LocalToWorld(Vector(0,6,-20)),CollideSound={ "gore/flesh" .. math.random(1, 3) .. ".wav"}})
	self:CreateGibEntity("obj_vj_gib","models/vj_hlr/gibs/flesh3.mdl",{BloodDecal="VJ_HLR_Blood_Red",Pos=self:LocalToWorld(Vector(0,-1,-20)),CollideSound={ "gore/flesh" .. math.random(1, 3) .. ".wav"}})
	self:CreateGibEntity("obj_vj_gib","models/vj_hlr/gibs/flesh4.mdl",{BloodDecal="VJ_HLR_Blood_Red",Pos=self:LocalToWorld(Vector(0,-2,-20)),CollideSound={ "gore/flesh" .. math.random(1, 3) .. ".wav"}})
	self:CreateGibEntity("obj_vj_gib","models/vj_hlr/gibs/flesh1.mdl",{BloodDecal="VJ_HLR_Blood_Red",Pos=self:LocalToWorld(Vector(0,-3,-20)),CollideSound={ "gore/flesh" .. math.random(1, 3) .. ".wav"}})
	self:CreateGibEntity("obj_vj_gib","models/vj_hlr/gibs/flesh2.mdl",{BloodDecal="VJ_HLR_Blood_Red",Pos=self:LocalToWorld(Vector(0,-4,-20)),CollideSound={ "gore/flesh" .. math.random(1, 3) .. ".wav"}})
	self:CreateGibEntity("obj_vj_gib","models/vj_hlr/gibs/flesh3.mdl",{BloodDecal="VJ_HLR_Blood_Red",Pos=self:LocalToWorld(Vector(0,-5,-20)),CollideSound={ "gore/flesh" .. math.random(1, 3) .. ".wav"}})
	self:CreateGibEntity("obj_vj_gib","models/vj_hlr/gibs/flesh4.mdl",{BloodDecal="VJ_HLR_Blood_Red",Pos=self:LocalToWorld(Vector(0,-6,-20)),CollideSound={ "gore/flesh" .. math.random(1, 3) .. ".wav"}})
...
local colorRed = VJ_Color2Byte(Color(130, 19, 10))
    ...
    if hitgroup == HITGROUP_LEFTLEG and self.totalDamage[hitgroup] > 39000 then
        ...
        self:SetBodygroup(5, 1)
        self:TakeDamage(self:Health(), ply, ply)
    elseif hitgroup == HITGROUP_RIGHTLEG and self.totalDamage[hitgroup] > 39000 then
...
elseif hitgroup == HITGROUP_HEAD and self.totalDamage[hitgroup] > 1000 then
	...
	self:SetBodygroup(0, 1)
    elseif hitgroup == HITGROUP_STOMACH and self.totalDamage[hitgroup] > 28000 then
	...
	self:SetBodygroup(2, 1)
        self:TakeDamage(self:Health(), ply, ply)
    elseif hitgroup == HITGROUP_CHEST and self.totalDamage[hitgroup] > 28000 then
        if self:GetBodygroup(6) == 1 then
            return
        end
	...
	self:SetBodygroup(6, 1)
        self:TakeDamage(self:Health(), ply, ply)		
    elseif hitgroup == HITGROUP_LEFTARM and self.totalDamage[hitgroup] > 38000 then
        ...
        self:SetBodygroup(3, 1)
        self:TakeDamage(self:Health(), ply, ply)
    elseif hitgroup == HITGROUP_RIGHTARM and self.totalDamage[hitgroup] > 38000 then
