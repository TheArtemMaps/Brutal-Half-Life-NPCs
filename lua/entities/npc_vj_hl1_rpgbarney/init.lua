...
-----------------------------------------------*/
ENT.Model = {"models/hl1/rpgbarney.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 90
...
self.SoundTbl_MeleeAttackMiss = {"npc/zombie/claw_miss1.wav","npc/zombie/claw_miss2.wav"}
	...
	self:Give("weapon_vj_hlr1_rpgbarn")
end
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:Controller_IntMsg(ply, controlEnt)
	ply:ChatPrint("LALT: Holster / Unholster RPG")
end
---------------------------------------------------------------------------------------------------------------------------------------------
